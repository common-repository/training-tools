...
class TRAININGTOOLS_Help {
    ...
    * @param string $readmoreurl   i.e. http://webtechglobal.co.uk/blog/wordpress/trainingtools/how-to-create-new-projects
    ...
    */
    public function get_help_array() {   
        ...
        // PAGE: main
        $h[ 'main' ][ 'pageinfo' ] = self::enterpage( __( 'Welcome', 'trainingtools' ), __( 'My name Ryan Bayne and I created this plugin. I can also help you at anytime. This help tab is not complete and will eventually offer help content for every feature.', 'trainingtools' ), TRAININGTOOLS_PORTAL, TRAININGTOOLS_YOUTUBEPLAYLIST );

        // PAGE TEST 1: postssection (manually typed)    
        $h[ 'postssection' ][ 'pageinfo' ][ 'pagetitle' ]       = __( 'Test Page', 'trainingtools' ); 
        $h[ 'postssection' ][ 'pageinfo' ][ 'pageabout' ]       = __( 'Beta Testing: These settings reflect what WordPress already has to offer. You will find these settings on the Edit Post screen and in most other .csv import plugins.', 'trainingtools' );    
