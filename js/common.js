/**
 * JavaScript code for all Training Tools admin screens, it makes postboxes work
 *
 * @package Training Tools
 * @subpackage Views JavaScript
 * @author Tobias Bäthge (author of TRAININGTOOLS plugin)
 * @since 0.0.1
 */
...
jQuery( document ).ready( function( $ ) {
	 ...
	 * For TRAININGTOOLS, pagenow has the form "tablepress_{$action}"
	 *
	 * @since 0.0.1
	 */
