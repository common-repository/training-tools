<?php
/**
 * Build the content for a form guide one input at a time. The 
 * form guide can be used in the WordPress Help tab and also for
 ...
 * @since 0.0.1
 * 
 * @todo add ability to collect technical form data from the plugin and paste it into the form guide builder view
 */

// Prohibit direct script loading
defined( 'ABSPATH' ) || die( 'No direct script access allowed!' );

class TRAININGTOOLS_Buildformguides_View extends TRAININGTOOLS_View {

    protected $screen_columns = 2;
    
    protected $view_name = 'buildformguides';
    ...
    */
    public function meta_box_array() {
        ...
        return $this->meta_boxes_array = array(
            ...
            //array( $this->view_name . '-importbranding', __( 'Import Branding', 'trainingtools' ), array( $this, 'parent' ), 'normal','default',array( 'formid' => 'importbranding' ), true, 'activate_plugins' ),
        );    
    }
    ...
    */    
    public function postbox_buildmenu_viewintroduction( $data, $box ) {
        $title_text = __( 'About Form Guides', 'trainingtools' );
        $intro_text = __( 'Enter instructions about a form with each input having its own content. We enter form ID and input ID so the data entered here can support developers. Forms and inputs can be linked to page guides so that those guides can list even more information.', 'trainingtools' );
        $subtitle_text = false;
    ...
    */
    public function postbox_postssection_importbranding( $data, $box ) {    
        $this->UI->postbox_content_header( $box['title'], $box['args']['formid'], __( 'Import both project and in the verse branding to the media gallery i.e. corporation logos.', 'trainingtools' ), false );        
