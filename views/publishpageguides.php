<?php
/**
 * Build page guides view.
 * 
 * Plugin: an intro, main tutorial video, main URL for support
 * Website: the posts content is reserved for designing a detailed tutorial or guidance for using the overall view
 * 
 * If the content of a page guide post is not used then the 
 * post type template will display content using meta and
 * taxonomy. A default layout will be used that lists
 * all forms and features for the page/view.
 * 
 * If content is used even a little then the template relies
 * on that content.
 * 
...
class TRAININGTOOLS_Buildpageguides_View extends TRAININGTOOLS_View {

    protected $screen_columns = 2;
    
    protected $view_name = 'buildpageguides';
