...
class TRAININGTOOLS_Tableforms_View extends TRAININGTOOLS_View {
    ...
    protected $view_name = 'tableforms';
    ...
    */
    ...
    public function setup( $action, array $data ) {
        ...
        $this->TRAININGTOOLS = TRAININGTOOLS::load_class( 'TRAININGTOOLS', 'class-multitool.php', 'classes' );
    ...
    */
    public function datatables( $data, $box ) {       
        ...
        $WPTableObject = new TRAININGTOOLS_WPTable_TableForms();
        
        // get all registered items (pages, forms, inputs and postboxes)
        $data = $this->TRAININGTOOLS->get_forms();
        ?>
        ...
        <form method="get">
            ...
            $WPTableObject->prepare_items_further( $data, 5 );
...
*/
class TRAININGTOOLS_WPTable_TableForms extends WP_List_Table {
    ...
    **************************************************************************/
    ...
    function get_columns() {
        $columns = array(
            ...
            'dbform_id' => 'ID',
            'location_id' => __( 'Location ID', 'trainingtools' ),
            'location_type' => __( 'Location Type', 'trainingtools' ),
            'form_id' => __( 'HTML ID', 'trainingtools' ),
            'form_name' => __( 'HTML Name', 'trainingtools' ),
            'timestamp' => __( 'Created', 'trainingtools' ),
        );
    ...
    function column_cb( $item ) {
        return sprintf(
            '<input type="checkbox" name="ttform[]" value="%s" />', $item['dbform_id']
        );    
    }
