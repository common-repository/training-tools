...
class TRAININGTOOLS_Tableinputs_View extends TRAININGTOOLS_View {
    ...
    protected $view_name = 'tableinputs';
    ...
    */
    public function datatables( $data, $box ) {       
        ...
        $WPTableObject = new TRAININGTOOLS_WPTable_TableInputs();
        
        // get all registered items (pages, forms, inputs and postboxes)
        $data = $this->TRAININGTOOLS->get_inputs();
        ?>
...
*/
class TRAININGTOOLS_WPTable_TableInputs extends WP_List_Table {
    ...
    **************************************************************************/
    ...
    function get_columns() {
        $columns = array(
            'dbinput_id' => 'ID',
            'form_id' => __( 'Form ID', 'trainingtools' ),
            'att_id' => __( 'HTML ID', 'trainingtools' ),
            'att_name' => __( 'HTML Name', 'trainingtools' ),
    ...
    function column_cb( $item ) {
        return sprintf(
            '<input type="checkbox" name="ttinpu[]" value="%s" />', $item['dbform_id']
        );    
    }
