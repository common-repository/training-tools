...
class TRAININGTOOLS_Tablepages_View extends TRAININGTOOLS_View {
    ...
    protected $view_name = 'tablepages';
    ...
    */
    public function datatables( $data, $box ) {       
        ...
        $data = $this->TRAININGTOOLS->get_pages();
        ?>
    ...
    **************************************************************************/
    ...
    function get_columns() {
        ...
        $columns = array(
            ...
            'ttpage_id' => 'ID',
            'project_id' => __( 'Project ID', 'trainingtools' ),
            'view_id' => __( 'View ID', 'trainingtools' ),
            'title' => __( 'Title', 'trainingtools' ),
    ...
    function column_cb( $item ) {
        return sprintf(
            '<input type="checkbox" name="ttpage[]" value="%s" />', $item['ttpage_id']
        );    
    }
